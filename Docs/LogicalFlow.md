...
It seems that all GenAI models responded correctly to the prompt, although the most detailed and fluid document structure can be observed in Copilot's response. Therefore, the Conclusion and Introduction are best prepared by ChatGPT. However, each structural element proposed by Gemini, has been tailored to individual audience groups.